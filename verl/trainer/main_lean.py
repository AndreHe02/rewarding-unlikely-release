...
from verl.trainer.ppo.ray_lean_trainer import RayLeanTrainer
...
@hydra.main(config_path="config", config_name="lean_trainer", version_base=None)
def main(config):
    run_ppo(config)
